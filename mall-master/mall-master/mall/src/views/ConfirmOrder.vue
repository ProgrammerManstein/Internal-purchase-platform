    ...
    <div class="content">
      ...
      <div class="section-address">
        ...
        <div class="address-body">
          <ul>
            <li :class="item.id == confirmAddress ? 'in-section' : ''" v-for="item in address" :key="item.id" @click="changeChecked(item.id)">
              <h2>{{item.name}}</h2>
      ...
      <div class="section-goods">
        ...
        <div class="goods-list">
          <ul>
            <li v-for="(item,index) in getCheckGoods" :key="index">
...
export default {
      ...
      address: [
        {
          ...
          name: '刘同学',
          phone: '15957109956',
          address: '浙江省 杭州市 下城区 潮王路18号 浙江工业大学'
        },
        {
          id: 2,
          name: '刘同学',
          phone: '15957109956',
          address: '浙江省 杭州市 西湖区 留和路288号 浙江工业大学'
        }
      ]
    }
  },
  created() {
    ...
    if (this.getCheckNum < 1) {
      this.$message.warning('请先勾选要购买的商品!')
